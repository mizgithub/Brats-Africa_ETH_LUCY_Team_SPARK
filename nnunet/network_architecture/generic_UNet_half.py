...
class Generic_Half_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 encoder_scale=1, axial_attention=False, heads=8, dim_heads=32, volume_shape=(128,128,128), no_attention=[0], dropout_level=[4]): #extra
        """
        ...
        """
        super(Generic_Half_UNet, self).__init__()
        ...
        for usl in range(int(num_pool/2) - 1):
