...
from nnunet.training.data_augmentation.data_augmentation_minimal import get_minimal_augmentation
...
class nnUNetTrainerV2_Minimal_DataAugmentation(nnUNetTrainerV2):
    ...
    def initialize(self, training=True, force_load_plans=False):
        if not self.was_initialized:
            ...
            if training:
                ...
                self.tr_gen, self.val_gen = get_minimal_augmentation(self.dl_tr, self.dl_val,
